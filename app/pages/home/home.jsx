      ...
      <div style={{backgroundImage: `url(${_config.urls.static}coffee-cup-laptop-and-notepad.png)`}} className='sign-in'>
        <div className='sign-in-wrap'>
          ...
          <button className='login-form__button'>
            ...
            <span className='login-form__text or'>or</span>
            <div className='group'>
                <input type='text' 
                style={{background: `url(${_config.urls.static}mail.svg) no-repeat 5% 50%`}} 
                className='group__input' 
                placeholder={_config.translations.enter_email} />
              </div>
              <div className='group'>
                <input type='password' 
                style={{background: `url(${_config.urls.static}lock.svg) no-repeat 5% 50%`}} 
                className='group__input' 
                data-type='password' 
