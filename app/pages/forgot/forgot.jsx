...
class Forgot extends Component {
    ...
    return (<div className='forgot'>
      <div className='forgot-wrap'>
        <div className='forgot-close'>
          <div className='forgot-close-wrap' onClick={() => this.props.history.push(_config.routing.sign_in_path)}>
        ...
        <div className='forgot-wrap'>
          ...
          <form action={_config.translations.check_login} method='POST'>
            ...
            <div className='forgot-wrap-group'>
  ...
  render () {
    return (this.state.isGotIt ? this.gotIt() : this.forgot())
  }
}
